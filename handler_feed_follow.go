...
func (apiCfg *apiConfig) handlerGetFeedFollows(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	if err != nil {
		respondWithError(w, 400, fmt.Sprintf("Failed to retrieve feed follows: %s", err))
		return
	}
...
func (apiCfg *apiConfig) handlerDeleteFeedFollow(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	if err != nil {
		respondWithError(w, 400, fmt.Sprintf("Invalid feed follow ID: %s", err))
		return
	}
	...
	if err != nil {
		respondWithError(w, 400, fmt.Sprintf("Failed to delete feed follow: %s", err))
		return
	}
